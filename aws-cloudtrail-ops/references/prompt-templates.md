...
>
> This file contains only the **service-specific deltas** for `aws-cloudtrail-ops`:
...
| Placeholder | Value |
|---|---|
| `{{skill.name}}` | `aws-cloudtrail-ops` |
| `{{skill.service}}` | `cloudtrail` |
| `{{skill.aws_cli_svc}}` | `cloudtrail` |
