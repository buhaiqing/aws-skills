...
|---|---|
| `delete-resource-share` | `confirm=DELETE_RESOURCE_SHARE <arn>` |
| `delete-permission` | `confirm=DELETE_PERMISSION <arn>` |
| `delete-permission-version` | `confirm=DELETE_PERMISSION_VERSION <arn> <version>` |
| `reject-resource-share-invitation` | `confirm=REJECT_INVITATION <arn>` |
