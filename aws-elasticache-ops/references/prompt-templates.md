...
>
> This file contains only the **service-specific deltas** for `aws-elasticache-ops`:
...
| Placeholder | Value |
|---|---|
| `{{skill.name}}` | `aws-elasticache-ops` |
| `{{skill.service}}` | `elasticache` |
| `{{skill.aws_cli_svc}}` | `elasticache` |
