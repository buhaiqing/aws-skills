...
| Skill | Command | Error | Root Cause | Fix | Count | Timestamp |
|-------|---------|-------|------------|-----|-------|-----------|
| ec2-ops | terminate-instances | MissingParameter | Missing `--instance-ids` | --instance-ids i-xxx | 4x | 2026-08-22 |
| ec2-ops | run-instances | InvalidParameterValue | SecurityGroupIds format | --security-group-ids sg-xxx | 3x | 2026-08-22 |
| rds-ops | delete-db-instance | MissingParameter | Missing `--db-instance-identifier` | --db-instance-identifier mydb | 3x | 2026-08-22 |
| s3-ops | delete-bucket | NoSuchBucket | Bucket doesn't exist or wrong region | Verify bucket exists first | 2x | 2026-08-22 |
| iam-ops | delete-user | NoSuchEntity | User doesn't exist | Check `list-users` first | 2x | 2026-08-22 |
| lambda-ops | delete-function | ResourceNotFoundException | Function name wrong | Verify with `list-functions` | 2x | 2026-08-22 |
